...
class SupabaseServiceProvider extends ServiceProvider
{
        ...
        $this->app->afterResolving('filesystem', function ($filesystem) {
            $filesystem->extend('supabase', function ($app, $config) {
                ...
                return new \Illuminate\Filesystem\FilesystemAdapter(
                    new \App\Services\Supabase\Storage\SupabaseFilesystemAdapter(
                        $storage,
    ...
    private function registerCommands(): void
    {
        if ($this->app->runningInConsole()) {
            $this->commands([
                \App\Console\Commands\SupabaseSyncCommand::class,
                \App\Console\Commands\SupabaseSyncWorkCommand::class,
                \App\Console\Commands\SupabaseRlsCommand::class,
            ]);
        }
    }
